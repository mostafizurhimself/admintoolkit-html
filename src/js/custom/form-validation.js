const customFormValidationSourceCode = `
  <form id="form-custom-validation" class="max-w-lg p-4 mx-auto bg-white border border-dark-300 shadow rounded-md dark:bg-dark-800 dark:border-dark-600" novalidate>
    <!-- Form Body -->
